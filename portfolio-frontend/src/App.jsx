...
function PageLayout({ title, subtitle, children }) {
  return (
    <main className="flex-1 overflow-y-auto px-4 sm:px-6 py-12 scroll-smooth z-0">
...
function App() {
  return (
    <div className="flex flex-col h-screen bg-[#09090b] text-zinc-100 font-sans selection:bg-brand-500/30 overflow-hidden noise-overlay">
